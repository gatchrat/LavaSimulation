...
using TMPro;
public class PerformanceAmlembc : MonoBehaviour
{
    public ParticleSystem refScript;
    ...
    private void UpdateParticles()
    {
        ...
        TimeSinceTick = 0;
        int curParticle = Cube.mesh.vertexCount;
        ...
        ParticleText.text = curParticle.ToString() + " Verts";
